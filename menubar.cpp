...
MenuBar::MenuBar(QWidget* parent) : QMenuBar{parent} {
  ...
  // file action
  actNewText_ = menuFile_->addAction(QIcon(":/resfiles/icon/N.png"),
                                     tr("新建文本文件(&N)"));
  actNewText_->setShortcut(Qt::CTRL + Qt::Key_N);

  actNew_ = menuFile_->addAction(QIcon(":/resfiles/icon/F.png"),
                                 tr("新建文件...(&F)"));
  ...
  actSave_ = menuFile_->addAction(QIcon(":/resfiles/icon/S.png"),
                                  tr("保存文件(&S)"));
  actSave_->setShortcut(Qt::CTRL + Qt::Key_S);

  actSaveAs_ = menuFile_->addAction(QIcon(":/resfiles/icon/A.png"),
                                    tr("另存为文件...(&A)"));
  actSaveAs_->setShortcut(Qt::CTRL + Qt::ALT + Qt::Key_S);

  actSaveAll_ = menuFile_->addAction(QIcon(":/resfiles/icon/L.png"),
                                     tr("保存所有文件(&L)"));
  actSaveAll_->setShortcut(Qt::CTRL + Qt::SHIFT + Qt::Key_S);

  menuFile_->addSeparator();

  actClose_ = menuFile_->addAction(QIcon(":/resfiles/icon/W.png"),
                                   tr("关闭文件(&W)"));
  actClose_->setShortcut(Qt::CTRL + Qt::Key_W);

  actCloseAll_ = menuFile_->addAction(QIcon(":/resfiles/icon/X.png"),
                                      tr("关闭所有文件(&X)"));
  actCloseAll_->setShortcut(Qt::CTRL + Qt::SHIFT + Qt::Key_W);

  menuFile_->addSeparator();

  actQuit_ = menuFile_->addAction(QIcon(":/resfiles/icon/Q.png"),
                                  tr("退出程序(&Q)"));
  actQuit_->setShortcut(Qt::CTRL + Qt::Key_Q);

  //   edit action
  actUndo_ = menuEdit_->addAction(QIcon(":/resfiles/icon/U.png"),
                                  tr("撤销(&U)"));
  actUndo_->setShortcut(Qt::CTRL + Qt::Key_Z);

  actRedo_ = menuEdit_->addAction(QIcon(":/resfiles/icon/R.png"),
                                  tr("恢复(&R)"));
  actRedo_->setShortcut(Qt::CTRL + Qt::Key_Y);

  menuEdit_->addSeparator();

  actCut_ = menuEdit_->addAction(QIcon(":/resfiles/icon/T.png"),
                                 tr("剪切(&T)"));
  actCut_->setShortcut(Qt::CTRL + Qt::Key_X);

  actCopy_ = menuEdit_->addAction(QIcon(":/resfiles/icon/C.png"),
                                  tr("复制(&C)"));
  actCopy_->setShortcut(Qt::CTRL + Qt::Key_C);

  actPaste_ = menuEdit_->addAction(QIcon(":/resfiles/icon/P.png"),
                                   tr("粘贴(&P)"));
  actPaste_->setShortcut(Qt::CTRL + Qt::Key_V);

  menuEdit_->addSeparator();

  actSelectAll_ = menuEdit_->addAction(
      QIcon(":/resfiles/icon/A.png"), tr("全选(&A)"));
  actSelectAll_->setShortcut(Qt::CTRL + Qt::Key_A);

  menuEdit_->addSeparator();

  actGo_ = menuEdit_->addAction(QIcon(":/resfiles/icon/G.png"),
                                tr("转到(&G)"));
  actGo_->setShortcut(Qt::CTRL + Qt::Key_G);
  // view action
  actZoomInFont_ = menuView_->addAction(
      QIcon(":/resfiles/icon/P.png"), tr("放大编辑字体(&P)"));
  actZoomInFont_->setShortcut(Qt::CTRL + Qt::Key_Equal);

  actZoomOutFont_ = menuView_->addAction(
      QIcon(":/resfiles/icon/M.png"), tr("缩小编辑字体(&M)"));
